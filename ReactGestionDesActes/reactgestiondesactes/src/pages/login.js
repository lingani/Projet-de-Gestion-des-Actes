        ...
        if(this.state.loginStatus === 0){
            ...
            return(
                <div className="alert alert-success">
                    <strong>Logging Successfull</strong>
                </div>
            );
        ...
        return (
            <React.Fragment>
                ...
                <div className="login-box">
                    <div className="logo">
                        <a href="#"><b>VENEEM</b></a>
                        <small>Informations sur les actes et services publics</small>
                    </div>
                    <div className="card">
                        <div className="body">
                            <form id="sign_in" method="POST" onSubmit={this.formSubmit}>
                                <div className="msg">Veuillez vous connecter</div>
                                <div className="input-group">
                                    <span className="input-group-addon">
                                        <i className="material-icons">person</i>
                                    </span>
                                    <div className="form-line">
                                        <input type="text" className="form-control" name="username" placeholder="Identifiant" required autoFocus onChange={this.saveInputs}/>
                                    </div>
                                </div>
                                <div className="input-group">
                                    <span className="input-group-addon">
                                    ...
                                    <div className="form-line">
                                        <input type="password" className="form-control" name="password" placeholder="Mot de passe" required onChange={this.saveInputs}/>
                                    </div>
                                </div>
                                <div className="row">
                                    ...
                                    <div className="col-xs-5">
                                        <button className="btn btn-block bg-pink waves-effect" type="submit" disabled={this.state.btnDisabled}>SE CONNECTER</button>
                                    </div>
                                </div>
